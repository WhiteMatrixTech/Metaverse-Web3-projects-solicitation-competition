...
function PaintingManager(app) {
    ...
    return {
        ...
        doPaint: function(colour, x, y, count, shares, user) {
            var a = this;
            return new Promise((resolve, reject) => {
                ...
                // Add to DB:
                user.addPixel(colour, x, y, count, shares, app, (changed, err) => {
                    ...
                    const info = {x: x, y: y, colour: Pixel.getHexFromRGB(colour.r, colour.g, colour.b)};
